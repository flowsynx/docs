  ...
  return (
    <section className='padding-vert--lg'>
      <div className="container">
        ...
        <div className="row">
          <div className="col">
            FlowSynx is a program to manage files on cloud storage and locally. 
            It is a feature-rich alternative to cloud vendors' web storage interfaces. 
            It will try to cover and support most of the cloud storage products including S3 object stores, 
