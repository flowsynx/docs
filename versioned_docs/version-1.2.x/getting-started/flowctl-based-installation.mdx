...
<Tabs groupId="operating-systems">
  <TabItem value="linux" label="Linux">
    ...
    The following example shows how to install **flowctl** version `1.2.4`.
    ```
    wget -q https://raw.githubusercontent.com/flowsynx/flowctl/master/install/install.sh -O - | /bin/bash -s 1.2.4
    ```
    ...
    The following example shows how to install **flowctl** version `1.2.4`.
    ```
    wget -q https://raw.githubusercontent.com/flowsynx/flowctl/master/install/install.sh -O - | FLOWCTL_INSTALL_DIR="$HOME/flowctl" /bin/bash -s 1.2.4
    ```
  </TabItem>
  <TabItem value="windows" label="Windows">
    ...
    The following example shows how to install **flowctl** version `1.2.4`.
    ```
    $script=iwr -useb https://raw.githubusercontent.com/flowsynx/flowctl/master/install/install.ps1; $block=[ScriptBlock]::Create($script); invoke-command -ScriptBlock $block -ArgumentList "1.2.4"
    ```
    ...
    ```
    $Env:FLOWCTL_INSTALL_DIR = "<your_alt_install_dir_path>"
    $script=iwr -useb https://raw.githubusercontent.com/flowsynx/flowctl/master/install/install.ps1; $block=[ScriptBlock]::Create($script); invoke-command -ScriptBlock $block -ArgumentList "1.2.4", "$Env:FLOWCTL_INSTALL_DIR"
    ```
  </TabItem>
  <TabItem value="macos" label="MacOS">
    ...
    The following example shows how to install **flowctl** version `1.2.4`.
    ```
    curl -fsSL https://raw.githubusercontent.com/flowsynx/flowctl/master/install/install.sh | /bin/bash -s 1.2.4
    ```
    ...
    **flowctl** to an alternate directory via the FLOWCTL_INSTALL_DIR environment variable. 
    ...
    The following example shows how to install **flowctl** version `1.2.4`.
    ```
    curl -fsSL https://raw.githubusercontent.com/flowsynx/flowctl/master/install/install.sh | FLOWCTL_INSTALL_DIR="$HOME/flowctl" /bin/bash -s 1.2.4
    ```
  </TabItem>
</Tabs>
