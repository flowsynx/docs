...
- **Authorization:**  ✅ Required (`admin` or `logs` role)
...
| ---------- | ------ | -------- | --------------------------------------------------------                             |
| `level`    | string | Optional | Log level filter ( `Critical`, `Error`, `Warning`, `Information`, `Debug`, `Trace` ) |
...
- Supported Log level: `Critical`, `Error`, `Warning`, `Information`, `Debug`, `Trace`
:::