...
- **[FSX 2210]** Plugin registry plugin versions not found.
...
- **[FSX 2445]** Workflow schema invalid URL.
- **[FSX 2446]** Workflow schema invalid payload.

## Expression Parser Error Codes
- **[FSX 2601]** Output not found for expression parser result.

## Secret Error Codes
- **[FSX 2701]** Secret configuration invalid provider name.

## AI Error Codes
- **[FSX 3001]** AI configuration invalid provider name.

## Notification Error Codes
- **[FSX 3101]** Notification configuration invalid provider name.
