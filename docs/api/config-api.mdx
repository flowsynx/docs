...
| -------------------- | ------ | -------------------- | ---- | -------------- |
| List Configurations  | GET    | `/config`            | No   | ✔️             |
| Add Configuration    | POST   | `/config`            | Yes  | ✔️             |
| Get Configuration    | GET    | `/config/{configId}` | No   | ✔️             |
| Update Configuration | PUT    | `/config`            | Yes  | ✔️             |
| Delete Configuration | DELETE | `/config/{configId}` | No   | ✔️             |
