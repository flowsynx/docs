...
## Step 2: Create a Simple Single-Task Workflow (≈3 min)
...
## Step 3: Add Task Dependencies (2--3 Tasks) (≈5--7 min)
...
#### Create a read → load csv → compres → write pipeline
...
## Step 5: Use Expressions for Dynamic Values (≈5--7 min)
...
Expressions use the platform’s configured parser (e.g., `$[...]` syntax).
...
## Step 6: Execute and Monitor (≈5 min)
