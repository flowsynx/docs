...
<table>
  ...
  <tr>
    ...
    <td>The storage path from which the entities are to be copied</td>
  </tr>
  <tr>
    ...
    <td class="centering"></td>
    <td class="centering greenIcon"><IIcon icon="mdi:check" height="32" /></td>
    <td>The storage path to which the entities are to be copied</td>
  </tr>
  <tr>
    <td>**Include**</td>
    <td class="centering">string</td>
  ...
  <tr>
    ...
    <td class="centering">false</td>
    <td></td>
    <td>Clearing all entities and other things in the destination path before starting the copy operation</td>
  </tr>
  <tr>
    <td>**OverWriteData**</td>
    <td class="centering">bool</td>
    <td class="centering">false</td>
    <td></td>
    <td>Overwriting the data if the entity exists on the destination</td>
  </tr>
</table>
...
<table class="table">
  ...
  <tr>
    <td>http://localhost:5860/storage/copy</td>
...
<Tabs groupId="httpApi">
  ...
  ```
  Invoke-RestMethod -Method Post -ContentType 'application/json' -Body '{ "sourcePath": "C:/sourcePath/", "destinationPath": "C:/destinationPath", "include": "", "exclude": "", "minAge": "", "maxAge": "", "minSize": "", "maxSize": "", "caseSensitive": false, "recurse": true, "clearDestinationPath": false, "overWriteData": true }' -Uri 'http://localhost:5860/storage/copy'
  ```
  </TabItem>
</Tabs>
